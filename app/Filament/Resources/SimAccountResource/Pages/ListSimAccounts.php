...
use function App\Filament\Resources\checkCreateSimAccountPermission;
use function App\Filament\Resources\checkReadSimAccountPermission;

class ListSimAccounts extends ListRecords
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            Actions\CreateAction::make()->visible(function(){
                return checkCreateSimAccountPermission();
            }),
        ];
    }
    ...
    public function mount(): void
    {
        ...
        $activity = AuditTrail::create([
            ...
            "module" => "Sim Accounts",
            "activity" => "Viewed List Sim Accounts Page",
